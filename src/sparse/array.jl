...
Adapt.adapt_storage(::AMDGPU.ROCArrayKernelAdaptor, xs::AbstractSparseArray) =
    adapt(ROCArray, xs)
Adapt.adapt_storage(::AMDGPU.ROCArrayKernelAdaptor, xs::AbstractSparseArray{<:AbstractFloat}) =
